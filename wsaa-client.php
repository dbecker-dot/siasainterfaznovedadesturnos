...
define ("CERT", "CERTSIASA_13bc755aaf8903dc.crt");       # The X.509 certificate in PEM format
define ("PRIVATEKEY", "ClavePrivadaSIASA.key"); # The private key correspoding to CERT (PEM)
define ("PASSPHRASE", "ClavePrivadaSIASA"); # The passphrase (if any) to sign
...
function SignTRA()
{
   $fp = fopen('TRA.tmp','w');
    ...
    array("file://".PRIVATEKEY,PASSPHRASE),array(),!PKCS7_DETACHED);
...
$argv[1]='wgesstockdepositosfiscales';
echo $argv[1];
exit();
