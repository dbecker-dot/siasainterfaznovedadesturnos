...
define('SERVIDOR', 'http://localhost/siasainterfaznovedadesturnos');
//define('SERVIDOR', 'http://192.168.1.42/siasapp');
define('DB_HOST', 'SERVERHP-BKP');
...
//BASE RDS
define('DB_HOSTRDS', '192.168.1.90');
define('DB_USUARIORDS', 'DiegoBecker');
define('DB_PASSWORDRDS', 'D_becK456');
define('DB_BDRDS', 'slpyme_siasa');

//BASE RDS
define('DB_HOSTSIASA', '192.168.1.90');
define('DB_USUARIOSIASA', 'DiegoBecker');
define('DB_PASSWORDSIASA', 'D_becK456');
define('DB_BDSIASA', 'SIASA');
...
define ("TA", SERVIDOR.'/views/TA.xml');
