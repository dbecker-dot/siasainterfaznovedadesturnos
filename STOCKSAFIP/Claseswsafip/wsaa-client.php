...
define ("CERT", "C:/xampp/htdocs/SPGestion/ClasesFAE/Certificados/20165420501.crt");       # The X.509 certificate in PEM format
define ("PRIVATEKEY", "C:/xampp/htdocs/SPGestion/ClasesFAE/Certificados/20165420501.key"); # The private key correspoding to CERT (PEM)
...
function SignTRA()
{
	$STATUS=openssl_pkcs7_sign("C:/xampp/htdocs/SPGestion/ClasesFAE/TRA.xml", "C:/xampp/htdocs/SPGestion/ClasesFAE/TRA.tmp", 
		"file://".CERT, array("file://".PRIVATEKEY, PASSPHRASE), array(), !PKCS7_DETACHED);
	...
	if (!$STATUS) 
	{
  	...
  	$inf=fopen("C:/xampp/htdocs/SPGestion/ClasesFAE/TRA.tmp", "r");
  	$i=0;
  	$CMS="";
...
{
  	$client=new SoapClient(WSDL, array('proxy_host' => PROXY_HOST, 'proxy_port' => PROXY_PORT, 'soap_version' => SOAP_1_2, 'location' => URL, 
